...
export class HomeComponent implements AfterViewInit {
  ...
  initMap(){
    ...
    this.timeStamps = this.mapService.makeTimeStamps(this.leafletMap);
    ...
    this.markers_array_ = this.mapService.makePluviometricStationsMarkers(this.leafletMap);
    this.mapService.makeLightening(this.leafletMap);
  ...
  getCommonBaseLayers(map: any) {
   ...
   /*
    ...
    const coastlinesLayer = L.tileLayer.wms("https://ows.emodnet-bathymetry.eu/wms", {
      ...
      */
    const bathymetryGroupLayer = L.layerGroup([/*bathymetryLayer, coastlinesLayer,*/ osmLayer]);
    bathymetryGroupLayer.addTo(this.leafletMap);
    return {
